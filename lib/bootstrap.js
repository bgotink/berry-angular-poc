...
const {setResolveHook, ModuleNotFoundException} = require(
  pnpapi.resolveRequest('@angular-devkit/core/node/resolve', path.dirname(require.resolve('@angular/cli/package.json')))
);
