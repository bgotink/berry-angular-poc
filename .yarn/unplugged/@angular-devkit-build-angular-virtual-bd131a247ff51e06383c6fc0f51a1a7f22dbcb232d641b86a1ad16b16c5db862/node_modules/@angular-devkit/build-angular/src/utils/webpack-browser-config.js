...
async function generateWebpackConfig(context, workspaceRoot, projectRoot, sourceRoot, options, webpackPartialGenerator, logger) {
    ...
    return scriptTargets.map(scriptTarget => {
        ...
        // PNP start
        const PnpWebpackPlugin = require('../pnp-loader');
        webpackConfig.resolve = (webpackConfig.resolve || {});
        webpackConfig.resolve.plugins = [...(webpackConfig.resolve.plugins || []), PnpWebpackPlugin];
        webpackConfig.resolveLoader = (webpackConfig.resolveLoader || {});
        webpackConfig.resolveLoader.plugins = [...(webpackConfig.resolveLoader.plugins || []), PnpWebpackPlugin.moduleLoader(module)];
        // PNP end
